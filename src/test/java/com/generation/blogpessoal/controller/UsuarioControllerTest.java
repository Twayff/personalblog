...
public class UsuarioControllerTest {
	...
	void start() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Rodolfo Ocanha", "rodolfo.ocanha@email.com", "gen2024", "-"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Juliana Andrews Ramos",
				"juliana_ramos@hotmail.com", "juliana123", "-");

		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(usuarioUpdate);

		ResponseEntity<Usuario> corpoResposta = testRestTemplate.withBasicAuth("rodolfo.ocanha@email.com", "gen2024")
	...
	public void deveMostrarTodosUsuarios() {
		...
		ResponseEntity<String> resposta = testRestTemplate.withBasicAuth("rodolfo.ocanha@email.com", "gen2024")
